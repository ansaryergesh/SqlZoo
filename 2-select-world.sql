...
SELECT name,(GDP/population) as GDPper from world 
WHERE population > 200000000

--4.Show the name and population in millions for the countries of the continent 'South America'
SELECT name, population/1000000 as PopulationInMillion from world
...
SELECT name, ROUND(population/1000000,2) as PopulationInMillion, ROUND(GDP/1000000000,2) as GDPinBil FROM world
WHERE continent = 'South America'
