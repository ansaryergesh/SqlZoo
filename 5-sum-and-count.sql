...
SELECT COUNT(*) total FROM world WHERE area >= 1000000

--5. What is the total population of ('France','Germany','Spain')
SELECT SUM(population) total FROM world WHERE name IN ('France','Germany','Spain')

--6. For each continent show the continent and number of countries.
SELECT continent, COUNT(name) countries FROM world GROUP BY continent
